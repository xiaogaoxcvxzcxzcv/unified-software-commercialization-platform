...
状态：`in_progress`（2026-07-22）。当前唯一关口；必须按 G2B-01 已封口模型先写 `000026_entitlement` 迁移，再实现 Domain/Application/PostgreSQL Adapter/API，不得提前进入 G2B-03。
...
G1-07/G1-07.1/G1-08.1/G1-08.2/G1-08.3/G1-08.4/G1-10/G1-11/G2A-01/G2A-02/G2A-03/G2A-04/G2A-04.1/G2A-05/G2A-06/G2A-07/G2A-08/G2B-01 已通过；当前唯一严格关口为 `in_progress` 的 G2B-02 Entitlement 后端与迁移。`package.account` 仅为 experimental verified candidate，`package.entitlement` 仍为 contracted，G2C 仍为 `planned`，不得跳过后续交付面。
