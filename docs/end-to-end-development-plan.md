...
状态：`implemented`，等待托管 CI 与证据封口（2026-07-18）。ADR-0018、`000018` 至 `000022` 迁移、HostedInteraction Domain/Application/PostgreSQL/HTTP、Identity proof/grant 会话绑定和 7 条 Hosted 路由已实现；commit `8421568` 的本地真实 PostgreSQL Full 18/18 已通过。远端最终 `quality-gate` 与正式证据尚未完成，因此本关口仍未 `verified`，当前唯一严格关口仍为 G2A-04.1，G2A-05 保持 `planned`。
...
G1-07/G1-07.1/G1-08.1/G1-08.2/G1-08.3/G1-08.4/G1-10/G1-11/G2A-01/G2A-02/G2A-03/G2A-04 已通过；G2A-04.1 实现与本地真实 PostgreSQL Full 18/18 已完成，等待托管 CI 与证据封口；当前唯一严格关口仍为 G2A-04.1 HostedInteraction 所有权与登录/账号后端
