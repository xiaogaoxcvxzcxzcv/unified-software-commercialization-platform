...
G1-07/G1-07.1/G1-08.1/G1-08.2/G1-08.3/G1-08.4/G1-10/G1-11/G2A-01/G2A-02/G2A-03/G2A-04/G2A-04.1/G2A-05 已通过；G2A-05 的本地真实 PostgreSQL Full 18/18、真实浏览器正向 Account 流程、管理后台 149/149 和质量门禁均通过；当前唯一严格关口切换为 `planned` 的 G2A-06 用户前台 Hosted UI。`package.account` 仍为 `contracted`，不得跳过后续交付面。
