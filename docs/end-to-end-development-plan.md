...
状态：`in_progress`（2026-07-20）。G2A-06 已 verified；本关 SDK 会话持有、配置失败关闭、Generated Source 路径/所有权和包级样板契约已冻结，文件所有权分为 TypeScript SDK、Account 机器包内容、包级生成样板三组并行实现。G2A-08 必须保持 `planned`。
...
G1-07/G1-07.1/G1-08.1/G1-08.2/G1-08.3/G1-08.4/G1-10/G1-11/G2A-01/G2A-02/G2A-03/G2A-04/G2A-04.1/G2A-05/G2A-06 已通过；当前唯一严格关口为 `in_progress` 的 G2A-07 Account SDK、配置和源码。`package.account` 仍为 `contracted`，G2A-08 与 G2C 仍为 `planned`，不得跳过后续交付面。
