...
当前唯一严格关口：G1-10 公开 upgrade-plan/eject/rollback 生命周期 API
F0-02 已重新达标：首次失效历史保留，补救后的 PostgreSQL、浏览器和 Full 证据支持 `verified_after_remediation`
G1-07/G1-07.1/G1-08.1/G1-08.2/G1-08.3/G1-08.4 已通过；后续严格顺序：G1-10 lifecycle API -> G1-11 Extension Catalog
