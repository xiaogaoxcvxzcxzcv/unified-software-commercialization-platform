...
G1-07/G1-07.1/G1-08.1/G1-08.2/G1-08.3/G1-08.4/G1-10/G1-11/G2A-01/G2A-02/G2A-03/G2A-04/G2A-04.1/G2A-05/G2A-06/G2A-07 已通过；当前唯一严格关口切换为 `planned` 的 G2A-08 Account 包内九面验证。`package.account` 仍为 `contracted`，G2C 仍为 `planned`，不得跳过后续交付面。
