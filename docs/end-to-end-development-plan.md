...
G1-07/G1-07.1/G1-08.1/G1-08.2/G1-08.3/G1-08.4/G1-10/G1-11/G2A-01/G2A-02/G2A-03/G2A-04/G2A-04.1 已通过；G2A-04.1 的本地真实 PostgreSQL Full 18/18、Hosted 确定性并发专项、push run `29626935922` 和 PR run `29626937426` 均通过；当前唯一严格关口为仍处于 `planned`、尚未开始的 G2A-05 统一后台 Account Blocks
