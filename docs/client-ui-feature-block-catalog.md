...
| entitlement.summary | 当前会员与权益 | P0 | card / page | SDK 可信上下文、当前权益结论、功能清单、Revision | renew-selected、upgrade-selected、retry | 全端 | 无 | entitlement | not_ready（G2B-04 local full passed；browser/CI pending） |
