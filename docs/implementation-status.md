...
| 完整能力包目录 | package.account contracted | Account 独立 Manifest、配置 Schema、九面合同、Product User Access 边界和目录防泄漏已验证；G2A-03 至 G2A-06 的认证账号 API、准入、外部身份、安全通知、HostedInteraction、管理 Blocks 和用户 Blocks 均已 verified；普通与实验能力包目录仍为空 | G2A-07 SDK/配置/源码、G2A-08 包内验证和 G2C 装配回归；当前没有 verified/available 包 |
...
| identity | admin auth + G2A-04 external identity + G2A-04.1 hosted binding + G2A-05/G2A-06 verified | 管理认证、最终用户认证/账号、refresh 重放撤销、外部身份、注册验证/恢复投递、Hosted proof/grant 和管理 Blocks 已通过真实 PostgreSQL 与托管 CI；G2A-06 又验证了 active-only self-service session 投影、密码全路径清理和真实 Hosted 浏览器流程 | 生产 OIDC/微信 Provider E2E；G2A-07/G2A-08 |
| hosted-interaction | G2A-04.1 + G2A-06 verified | ADR-0018 所有权、`000018` 至 `000025`、interaction/browser session/completion grant、自助 profile/password/session 流、精确 return target、state/nonce/PKCE、一次性 code、Origin/CSRF 和幂等恢复已实现；G2A-06 真实 PostgreSQL、HTTPS 浏览器、响应头、本地 Full 20/20 与托管 required check 已通过 | G2A-07 SDK/配置/源码、G2A-08 包内九面验证 |
