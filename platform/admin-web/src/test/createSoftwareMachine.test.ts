...
const plan: AssemblyPlanRecord = {
  ...
  schema_version: "1.0.0",
  environment: "test",
  confirmation_checksum: "sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
  review: { packages: [{ package_id: "package.account", version: "1.0.0" }], applications: [{ application_id: "application.web", target: "web", channel: "web", delivery_mode: "generated_source", template_id: "standard-a", template_version: "1.0.0" }], risks: [], blocking_conflict_count: 0, statements: ["确认装配计划"] },
...
const running: AssemblyRunRecord = {
  ...
  output_target_ref: "target-1",
  status: "generating",
  current_step_id: "step-generate",
  steps: [],
  recovery: { retryable: false, rollback_required: false, resume_from_step_id: null },
  diagnostics: [],
  reports: [],
  document: {},
