...
var (
	...
	ErrDuplicateExtensionVersion = errors.New("duplicate trusted extension version")
	...
	ErrUnknownExtension          = errors.New("trusted product extension is unknown")
	ErrExtensionIncompatible     = errors.New("trusted product extension is incompatible")
	ErrExtensionConflict         = errors.New("trusted product extensions conflict")
)
