...
await mkdir(new URL("../dist/web-react/src/entitlement/", import.meta.url), { recursive: true });
...
await cp(new URL("../web-react/src/entitlement/entitlement-blocks.css", import.meta.url), new URL("../dist/web-react/src/entitlement/entitlement-blocks.css", import.meta.url));
